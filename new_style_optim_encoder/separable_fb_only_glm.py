...
from new_style_optim_encoder.glm_components import _flashed_spatial_stimulus_contrib_gensig, \
    _flashed_feedback_contrib_gensig, _movie_spatial_stimulus_contrib_gensig, _movie_feedback_contrib_gensig, \
    _flashed_timecourse_stimulus_contrib_gensig, _movie_timecourse_stimulus_contrib_gensig
from new_style_optim_encoder.glm_prox import _feedback_only_spatial_model_prox_project_variables


class NS_WNReg_SpatFit_FBOnlyGLM(nn.Module):
    '''
    ...
    def _eval_loss(self,
                   ...
                   wn_filt_feedback: torch.Tensor) -> torch.Tensor:
        '''
        ...
        ns_gen_sig = bias + ns_stimulus_contrib + ns_feedback_contrib
        ...
        wn_feedback_contrib = _movie_feedback_contrib_gensig(feedback_filt_w,
                                                             wn_filt_feedback)

        wn_gen_sig = bias + wn_stimulus_contrib + wn_feedback_contrib
...
class NS_WNReg_TimecourseFit_FBOnlyGLM(nn.Module):
    ...
    def _eval_loss(self,
                   ...
                   wn_filtered_feedback: torch.Tensor) -> torch.Tensor:
        '''
...
def new_style_joint_wn_flashed_fb_only_alternating_optim(
    ...
    :param ns_stimulus_frames:
    :param ns_spikes_cell:
    :param ns_stim_time_basis_conv:
    :param ns_feedback_basis_conv:
    :param wn_stimulus_frames:
    :param wn_spikes_cell:
    :param wn_feedback_basis_conv:
    ...
    feedback_w = initial_guess_feedback
    ...
    spat_opt_module = NS_WNReg_SpatFit_FBOnlyGLM(
        dim_spat,
        n_basis_feedback,
        weight_wn,
        loss_callable,
    ...
    timecourse_opt_module = NS_WNReg_TimecourseFit_FBOnlyGLM(
        n_basis_stim_time,
        n_basis_feedback,
        weight_wn,
        loss_callable,
    ...
    for (iter_num, spat_solver_params, time_solver_params) in \
        ...
        feedback_w, prev_iter_spatial_filter, bias = spat_opt_module.return_parameters_torch()
        ...
        feedback_w, timecourse_w, bias = timecourse_opt_module.return_parameters_torch()
    ...
    return loss_timecourse, (prev_iter_spatial_filter, timecourse_w, feedback_w, bias)
