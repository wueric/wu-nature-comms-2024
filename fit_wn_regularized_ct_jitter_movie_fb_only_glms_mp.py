...
from new_style_fit_multimovie_ct_glm import new_style_wn_regularized_precompute_convs_and_fit_glm, \
    new_style_wn_regularized_precompute_convs_and_fit_fb_only_glm
from optimization_encoder.separable_trial_glm import ProxSolverParameterGenerator
from optimization_encoder.trial_glm import FittedGLM, FittedGLMFamily, FittedFBOnlyGLM, FittedFBOnlyGLMFamily
from optimization_encoder.ct_glm import fused_bernoulli_neg_ll_loss
from fit_multimovie_ct_glm import compute_full_filters, compute_spat_timecourse_feedback_filters
...
def dumb_get_from_queue(input_data_queue: mp.Queue,
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('Fit LNBR (uncoupled) encoding models jointly to eye movements stimulus and white noise. Multiprocessing implementation.')
    ...
    parser.add_argument('-m', '--seconds_wn', type=int, default=300,
                        help='number of seconds of WN data to use')
